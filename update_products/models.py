...
class checkouts(Base):
    ...
    n_venta = Column(String(16), nullable=False)
...
class Product(Base):
    ...
    PreciosHites: Mapped[float] = mapped_column(Float, nullable=True)
    Preciosdelista: Mapped[float] = mapped_column(Float, nullable=True)
    PreciosRipley: Mapped[float] = mapped_column(Float, nullable=True)
    PreciosParis: Mapped[float] = mapped_column(Float, nullable=True)
    PreciosFalabella: Mapped[float] = mapped_column(Float, nullable=True)
    PreciosShopify: Mapped[float] = mapped_column(Float, nullable=True)
    PreciosHitesWithDiscount: Mapped[float] = mapped_column(Float, nullable=True)
    PreciosdelistaWithDiscount: Mapped[float] = mapped_column(Float, nullable=True)
    PreciosRipleyWithDiscount: Mapped[float] = mapped_column(Float, nullable=True)
